$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-light-conservatory-couch"] = new baselight("default-light-conservatory-couch", "", "default", {'widget_type': 'baselight', 'entity': 'light.conservatory_couch', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.conservatory_couch'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.conservatory_couch'}, 'fields': {'title': '', 'title2': '', 'icon': '', 'units': '%', 'level': '', 'state_text': '', 'icon_style': ''}, 'icons': {'icon_on': 'mdi-lightbulb-on', 'icon_off': 'mdi-lightbulb'}, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'level_style': 'color: #fff;', 'unit_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'level_down_style': 'color: #888;', 'widget_style': 'background-color: #444;'}, 'css': {'icon_style_active': 'color: yellow;', 'icon_style_inactive': 'color: grey;'}, 'title_is_friendly_name': 1, 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default', 'icon_on': 'mdi-lightbulb-on', 'icon_off': 'mdi-lightbulb', 'icon_style_active': 'color: yellow;', 'icon_style_inactive': 'color: grey;', 'clock': {'widget_type': 'clock', 'time_format': '24hr', 'date_format_country': 'dk', 'date_format_options': {'weekday': 'short', 'day': 'numeric', 'month': 'numeric'}, 'date_style': 'color: white; font-size: 200%', 'time_style': 'color: pink'}})
    
        widgets["default-light-dining-table-lights"] = new baselight("default-light-dining-table-lights", "", "default", {'widget_type': 'baselight', 'entity': 'light.dining_table_lights', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.dining_table_lights'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.dining_table_lights'}, 'fields': {'title': '', 'title2': '', 'icon': '', 'units': '%', 'level': '', 'state_text': '', 'icon_style': ''}, 'icons': {'icon_on': 'mdi-lightbulb-on', 'icon_off': 'mdi-lightbulb'}, 'static_icons': {'icon_up': 'fa-plus', 'icon_down': 'fa-minus'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'level_style': 'color: #fff;', 'unit_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'level_down_style': 'color: #888;', 'widget_style': 'background-color: #444;'}, 'css': {'icon_style_active': 'color: yellow;', 'icon_style_inactive': 'color: grey;'}, 'title_is_friendly_name': 1, 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default', 'icon_on': 'mdi-lightbulb-on', 'icon_off': 'mdi-lightbulb', 'icon_style_active': 'color: yellow;', 'icon_style_inactive': 'color: grey;', 'clock': {'widget_type': 'clock', 'time_format': '24hr', 'date_format_country': 'dk', 'date_format_options': {'weekday': 'short', 'day': 'numeric', 'month': 'numeric'}, 'date_style': 'color: white; font-size: 200%', 'time_style': 'color: pink'}})
